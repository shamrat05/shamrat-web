        ...
        >
          ...
          <div className="flex gap-3 justify-end">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-text-primary hover:text-primary-500 transition-colors"
            >
              Decline
            </button>
            <button
              onClick={handleAccept}
              className="px-4 py-2 text-sm font-medium bg-primary-600 text-white rounded-lg hover:bg-primary-500 transition-colors shadow-lg shadow-primary-600/25"
            >
              Accept
            </button>
          </div>
